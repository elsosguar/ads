package com.solodroid.ads.sdk.interstitial;
...
import static com.solodroid.ads.sdk.util.Constant.YANDEX;
...
import com.solodroid.ads.sdk.appopen.AppOpenAd;
            ...
            switch (adNetwork) {
                ...
                case WORTISE:
                    ...
                    wortiseInterstitialAd.setListener(new com.wortise.ads.interstitial.InterstitialAd.Listener() {
                        ...
                        @Override
                        public void onInterstitialRevenuePaid(@NonNull com.wortise.ads.interstitial.InterstitialAd interstitialAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                            // Revenue tracking - methods may vary by SDK version
                            Log.d(TAG, "[" + adNetwork + "] " + "Interstitial Revenue: " + revenueData.toString());
                        }
                    });
            ...
            switch (backupAdNetwork) {
                ...
                case WORTISE:
                    ...
                    wortiseInterstitialAd.setListener(new com.wortise.ads.interstitial.InterstitialAd.Listener() {
                        ...
                        public void onInterstitialRevenuePaid(@NonNull com.wortise.ads.interstitial.InterstitialAd interstitialAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                            // Revenue tracking - methods may vary by SDK version
                            Log.d(TAG, "[Wortise] [Backup] Interstitial Revenue: " + revenueData.toString());
                        }
                    });
                    wortiseInterstitialAd.loadAd();
                    break;
