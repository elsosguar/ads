package com.solodroid.ads.sdk.rewarded;
            ...
            switch (mainAds) {
                ...
                case WORTISE:
                    ...
                    wortiseRewardedAd.setListener(new com.wortise.ads.rewarded.RewardedAd.Listener() {
                        ...
                        @Override
                        public void onRewardedRevenuePaid(@NonNull com.wortise.ads.rewarded.RewardedAd rewardedAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                            // Revenue tracking - methods may vary by SDK version
                            Log.d(TAG, "[" + mainAds + "] " + "Rewarded Revenue: " + revenueData.toString());
                        }
                    });
            ...
            switch (backupAds) {
                ...
                case WORTISE:
                    ...
                    wortiseRewardedAd.setListener(new com.wortise.ads.rewarded.RewardedAd.Listener() {
                        ...
                        public void onRewardedRevenuePaid(@NonNull com.wortise.ads.rewarded.RewardedAd rewardedAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                            // Revenue tracking - methods may vary by SDK version
                            Log.d(TAG, "[" + backupAds + "] [backup] Rewarded Revenue: " + revenueData.toString());
                        }
                    });
                    wortiseRewardedAd.loadAd();
                    break;
