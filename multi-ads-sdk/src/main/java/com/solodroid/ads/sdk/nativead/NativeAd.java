package com.solodroid.ads.sdk.nativead;
                ...
                case WORTISE:
                    if (wortiseNativeAd.getVisibility() != View.VISIBLE) {
                        mGoogleNativeAd = new GoogleNativeAd(activity, wortiseNativeId, new GoogleNativeAd.Listener() {
                            ...
                            @Override
                            public void onNativeRevenuePaid(@NonNull GoogleNativeAd googleNativeAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                                // Revenue tracking - methods may vary by SDK version
                                Log.d(TAG, "[" + adNetwork + "] " + "Native Revenue: " + revenueData.toString());
                            }
                ...
                case WORTISE:
                    if (wortiseNativeAd.getVisibility() != View.VISIBLE) {
                        mGoogleNativeAd = new GoogleNativeAd(activity, wortiseNativeId, new GoogleNativeAd.Listener() {
                            ...
                            public void onNativeRevenuePaid(@NonNull GoogleNativeAd googleNativeAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                                // Revenue tracking - methods may vary by SDK version
                                Log.d(TAG, "[Backup] Native Revenue: " + revenueData.toString());
                            }
                        });
                        mGoogleNativeAd.load();
                    } else {
