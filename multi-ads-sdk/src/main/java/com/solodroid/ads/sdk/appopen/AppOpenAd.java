package com.solodroid.ads.sdk.appopen;
            ...
            switch (adNetwork) {
                ...
                case WORTISE:
                    ...
                    wortiseAppOpenAd.setListener(new com.wortise.ads.appopen.AppOpenAd.Listener() {
                        ...
                        @Override
                        public void onAppOpenRevenuePaid(@NonNull com.wortise.ads.appopen.AppOpenAd appOpenAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                            // Revenue tracking - methods may vary by SDK version
                            Log.d(TAG, "[" + adNetwork + "] " + "App Open Revenue: " + revenueData.toString());
                        }
                    });
            ...
            switch (backupAdNetwork) {
                ...
                case WORTISE:
                    ...
                    wortiseAppOpenAd.setListener(new com.wortise.ads.appopen.AppOpenAd.Listener() {
                        ...
                        public void onAppOpenRevenuePaid(@NonNull com.wortise.ads.appopen.AppOpenAd appOpenAd, @NonNull com.wortise.ads.RevenueData revenueData) {
                            // Revenue tracking - methods may vary by SDK version
                            Log.d(TAG, "[" + backupAdNetwork + "] " + "App Open Revenue: " + revenueData.toString());
                        }
                    });
                    wortiseAppOpenAd.loadAd();
                    break;
